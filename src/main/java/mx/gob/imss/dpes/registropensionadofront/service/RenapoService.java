 ...
 */
@Provider
public class RenapoService extends ServiceDefinition<ActivarRegistroRequest, ActivarRegistroRequest>{
    ...
    public Message<ActivarRegistroRequest> execute(Message<ActivarRegistroRequest> request) throws BusinessException {
        log.log(Level.INFO, ">>>>RenapoService Request: {0}", request.getPayload());
        ...
        log.log(Level.INFO, ">>>>  RenapoService response= {0}", response);
